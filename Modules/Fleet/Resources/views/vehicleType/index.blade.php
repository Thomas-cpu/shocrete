...
<div>
    ...
    <a  class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md" data-title="{{ __('Create VehicleType') }}" data-url="{{route('vehicleType.create')}}" data-bs-toggle="tooltip"  data-bs-original-title="{{ __('Create') }}">

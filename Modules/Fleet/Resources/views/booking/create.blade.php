...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            <label for="datetime" class="col-form-label">{{ __('End Date/Time') }}</label>
            <input class="form-control" value="{{ date('Y-m-d h:i') }}" placeholder="{{ __('Select Date/Time') }}"
                required="required" name="end_date" type="datetime-local">
        </div>
        <div class="form-group col-md-6">
            {!! Form::label('start_address', __('Start Location'), ['class' => 'form-label']) !!}
            <input type="text" class="form-control" id="ship-address" name="start_address" required
                autocomplete="off">
        </div>
        <div class="form-group col-md-6">
            {!! Form::label('end_address', __('End Location'), ['class' => 'form-label']) !!}
            <input type="text" class="form-control" id="ship-addresses" name="end_address" required
                autocomplete="off">
        </div>
        <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::number('total_price', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => 'Enter Total Amount']) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::text('notes', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => 'Enter Description']) }}
            </div>
        </div>
    </div>
</div>

...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group" style="display: none;">
            ...
            <div class="form-icon-user">
                {{ Form::password('password', ['class' => 'form-control', 'value' => '123456', 'required' => 'required', 'minlength' => '6', 'placeholder' => 'Enter Password']) }}
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                {{ Form::label('billing_state', __('Province'), ['class' => 'form-label']) }}
                <div class="form-icon-user">
                    {{ Form::text('billing_state', null, ['class' => 'form-control', 'placeholder' => __('Enter Province'), 'required' => 'required']) }}
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6">

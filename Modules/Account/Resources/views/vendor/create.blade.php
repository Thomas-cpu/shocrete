...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <!-- <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{Form::password('password',array('class'=>'form-control','required'=>'required','value' => '123456','minlength'=>"6",'placeholder'=>'Enter Password'))}}
                </div>
            </div>
        </div> -->
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
            ...
            <div class="form-group"   style="display: none;">
                ...
                <div class="form-icon-user">
                {{ Form::text('tax_number', '123456', ['class' => 'form-control', 'placeholder' => 'Enter Tax Number']) }}               
             </div>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                {{Form::label('billing_state',__('Province'),array('class'=>'form-label')) }}
                <div class="form-icon-user">
                    {{Form::text('billing_state',null,array('class'=>'form-control','placeholder'=>'Enter Province','required'=>'required'))}}
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6">
